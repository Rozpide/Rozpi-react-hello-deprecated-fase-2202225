...
export const Home = () => {
	...
	return (
		<div className="home-container">
			...
			<section className="section home__section-2">
				<h1>Últimos torneos añadidos</h1>
				<div className="container">
					<div className="row mt-5">
						<div className="col-md-4">
							<div className="card h-100 d-flex flex-column">
								<div className="card-body d-flex flex-column p-4">
									...
									<p className="card-text flex-grow-1">Dirección de la ubicación 1</p>
									<a href="#" className="btn btn-primary align-self-center mt-auto">Información</a>
								</div>
							</div>
						</div>
						<div className="col-md-4">
							<div className="card h-100 d-flex flex-column">
								<div className="card-body d-flex flex-column p-4">
									<h1 className="card-title">Ubicación 2</h1>
						...
						<div className="col-md-4">
							<div className="card h-100 d-flex flex-column">
								<div className="card-body d-flex flex-column p-4">
									<h1 className="card-title">Ubicación 3</h1>
									<p className="card-text flex-grow-1">Dirección de la ubicación 3</p>
									<a href="#" className="btn btn-primary align-self-center mt-auto">Información</a>
								</div>
							</div>
						</div>
			...
			<section className="section section-3 bg-light vh-25">
				<div className="container">
					<div className="row">
						<div className="col-md-4">
